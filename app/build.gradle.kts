...
android {
    namespace = "com.example.eva3programobile"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.eva3programobile"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    //Libreria google Play determinar ubicacion
    implementation("com.google.android.gms:play-services-location:21.0.1")
    //Open Street Map (Libreria abierta de mapa)
